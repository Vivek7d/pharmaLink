...
function SupplierPurchaseOrderTable() {
  ...
  return (
    ...
    >
      ...
      <div className="mb-4">
        <button className="relative flex justify-center items-center bg-black text-white border-none py-3 px-8 rounded-md overflow-hidden shadow-lg transition-all duration-250">
          <img
            src="/upload.png"
            alt="upload"
        ...
        <tbody>
          {filteredData.map((drug, index) => (
            ...
            >
              ...
              <td className="px-4 py-4">
                <h1 className="truncate w-56">{drug.dosage}</h1>
              </td>
              <td className="px-4 py-4">
              ...
              <td className="px-4 py-4">
                <h1 className="truncate w-56">{drug.manufacturer}</h1>
              </td>
              <td className="px-4 py-4">
                <h1 className="truncate w-56">{drug.hospitalName}</h1>
              </td>
              <td className="px-4 py-4">
                <h1 className="truncate w-56">{drug.hospitalLocation}</h1>
              </td>
              <td className="px-4 py-4">
              ...
              <td className="px-4 py-3">
                <Select
                  onValueChange={(value) => handleStatusChange(drug.id, value)}
                >
                  <SelectTrigger className="w-[180px]">
                    <SelectValue placeholder={drug.status} />
                  </SelectTrigger>
                  <SelectContent>
              ...
              <td className="px-4 py-4 text-center">
                <FaEdit
                  onClick={() => handleEditDamageDrug(drug)}
                  className="text-black hover:underline mr-2"
                />
                <MdDelete
                  onClick={() => handleDeleteDamageDrug(drug.id)}
